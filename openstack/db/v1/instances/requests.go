...
func (opts CreateOpts) ToInstanceCreateMap() (map[string]interface{}, error) {
	if opts.Size > 300 || opts.Size < 1 {
		...
		value := fmt.Sprintf("instances.CreateOpts.Size:%+v Size (GB) must be between 1-300", opts.Size)
	...
	if opts.FlavorRef == "" {
		message := fmt.Sprintf(gophercloud.CE_MissingInputMessage, "instances.CreateOpts.FlavorRef")
