...
func IDFromName(client *gophercloud.ServiceClient, name string) (string, error) {
	...
	case 0:
		...
		message := fmt.Sprintf(gophercloud.CE_ResourceNotFoundMessage, "subnet", name)
	...
	default:
		...
		message := fmt.Sprintf(gophercloud.CE_MultipleResourcesFoundMessage, count, "subnet", name)
