...
func IDFromName(client *gophercloud.ServiceClient, name string) (string, error) {
	...
	case 0:
		...
		message := fmt.Sprintf(gophercloud.CE_ResourceNotFoundMessage, "security group", name)
	...
	default:
		...
		message := fmt.Sprintf(gophercloud.CE_MultipleResourcesFoundMessage, count, "security group", name)
