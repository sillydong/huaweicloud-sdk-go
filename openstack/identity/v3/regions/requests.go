...
func Update(client *golangsdk.ServiceClient, regionID string, opts UpdateOptsBuilder) (r UpdateResult) {
...
func Delete(client *golangsdk.ServiceClient, regionID string) (r DeleteResult) {
