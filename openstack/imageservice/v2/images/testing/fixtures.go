...
// HandleCloudImageListSuccessfully test setup
func HandleCloudImageListSuccessfully(t *testing.T) {
...
// HandleCloudImageUpdateSuccessfully setup
func HandleCloudImageUpdateSuccessfully(t *testing.T) {
	th.Mux.HandleFunc("/cloudimages/da3b75d9-3f4a-40e7-8a2c-bfab23927dea", func(w http.ResponseWriter, r *http.Request) {
		th.TestMethod(t, r, "PATCH")
		th.TestHeader(t, r, "X-Auth-Token", fakeclient.TokenID)
...
// HandleImageTagPutSuccessfully test setup
func HandleImageTagPutSuccessfully(t *testing.T) {
	th.Mux.HandleFunc("/images/imageID/tags/imageTag", func(w http.ResponseWriter, r *http.Request) {
		th.TestMethod(t, r, "PUT")
		w.WriteHeader(http.StatusNoContent)
	})
}

// HandleImageTagDeleteSuccessfully test setup
func HandleImageTagDeleteSuccessfully(t *testing.T) {
	th.Mux.HandleFunc("/images/imageID/tags/imageTag", func(w http.ResponseWriter, r *http.Request) {
		th.TestMethod(t, r, "DELETE")
		w.WriteHeader(http.StatusNoContent)
	})
