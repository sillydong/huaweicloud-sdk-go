...
func TestPutImageTag(t *testing.T) {

	th.SetupHTTP()
	defer th.TeardownHTTP()

	HandleImageTagPutSuccessfully(t)
	r := images.PutTag(fakeclient.ServiceClient(), "imageID", "imageTag")
...
func TestDeleteImageTag(t *testing.T) {
	...
	HandleImageTagDeleteSuccessfully(t)
