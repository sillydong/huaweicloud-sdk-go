...
func AttachInterface(t *testing.T, client *golangsdk.ServiceClient, serverID string) (*attachinterfaces.Interface, error) {
...
/*
func CreateAggregate(t *testing.T, client *golangsdk.ServiceClient) (*aggregates.Aggregate, error) {
...
// deferred function.
/*
func DeleteAggregate(t *testing.T, client *golangsdk.ServiceClient, aggregate *aggregates.Aggregate) {
...
func DeleteSecurityGroup(t *testing.T, client *golangsdk.ServiceClient, securityGroupID string) {
...
func DetachInterface(t *testing.T, client *golangsdk.ServiceClient, serverID, portID string) {
